...
Version  : 1.0.2
Release  : 51
URL      : https://cran.r-project.org/src/contrib/deldir_1.0-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/deldir_1.0-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633445733
