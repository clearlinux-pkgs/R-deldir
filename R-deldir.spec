...
Version  : 0.2.3
Release  : 40
URL      : https://cran.r-project.org/src/contrib/deldir_0.2-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/deldir_0.2-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604939887
