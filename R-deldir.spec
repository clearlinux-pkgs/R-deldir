...
popd
pushd ..
cp -a deldir buildavx512
popd
pushd ..
cp -a deldir buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740090736
...
/V4/usr/lib64/R/library/deldir/libs/deldir.so
/VA/usr/lib64/R/library/deldir/libs/deldir.so
